    ...
    <main className="min-h-screen bg-pink-200 text-stone-900">
      <header className="border-b border-pink-400 bg-pink-100/70 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <h1 className="font-display text-xl font-black uppercase tracking-[0.2em] text-stone-900">
            Clay Learning Hub
          </h1>
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        ...
        <h2 className="font-display max-w-3xl text-5xl font-black leading-[0.9] tracking-[0.02em] text-stone-950 md:text-7xl">
          Learn, Build, Create! 
        </h2>
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          <a
            href="#learn"
            className="rounded-full bg-stone-900 px-6 py-3 text-center text-sm font-black uppercase tracking-[0.2em] text-white transition hover:bg-stone-700"
          >
            Start Learning
          </a>
          ...
          <a
            href="#projects"
            className="rounded-full border border-stone-300 px-6 py-3 text-center text-sm font-black uppercase tracking-[0.2em] text-stone-800 transition hover:bg-white"
          >
      ...
      <section id="learn" className="mx-auto max-w-6xl px-6 py-12">
        <div className="mb-8">
          <h2 className="font-display text-3xl font-black tracking-[0.02em] text-stone-950">
            Choose Your Path
          </h2>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <article className="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm">
            <h3 className="font-display text-2xl font-black">Hand-Building</h3>
          ...
          <article className="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm">
            <h3 className="font-display text-2xl font-black">Potter&apos;s Wheel</h3>
            <p className="mt-3 leading-7 text-stone-700">
      ...
      >
        <div className="rounded-2xl bg-orange-100 p-6">
          <h2 className="font-display text-2xl font-black tracking-[0.02em] text-stone-950">
            Quick Reference
          </h2>
